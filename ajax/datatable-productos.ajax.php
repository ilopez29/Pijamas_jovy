	...
	public function mostrarTablaProductos(){
    	...
    	$orden = "id";
		  ...
		  for($i = 0; $i < count($productos); $i++){
		  	...
		  	$imagen = "<img src='".$productos[$i]["imagen"]."' width='150px' height='150px' onclick='javascript:this.width=338;this.height=350' ondblclick='javascript:this.width=150;this.height=150'>";
