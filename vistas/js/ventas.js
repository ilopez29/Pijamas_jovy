...
function sumarTotalPrecios(){
	...
	$("#totalVenta").number(sumaTotalPrecio,2)
...
$("#nuevoMetodoPago").change(function(){
	...
	if(metodo == "TC" || metodo == "TD" ){
		 ...
		 $(this).parent().parent().parent().children('.cajasMetodoPago').html(
		 	...
		 	'<div class="col-xs-5" style="padding-left:0px">'+
				...
				'<div class="input-group">'+
                  ...
                  '<p style="position:relative; top:-52px;">&nbsp;Codigo de Referencia</p>'+
                '</div>'+
		...
		$(this).parent().parent().addClass('col-xs-11');
		$(this).parent().parent().parent().children('.cajasMetodoPago').html(
			...
			'<div class="col-xs-1" style="padding-left:0px">'+
			   ...
			   '<div class="input-group">'+
				 ...
				 '<input type="text" min="0" style="border: 2px solid transparent;" class="form-control" id="nuevoCodigoTransaccion"  redondly>'+
...
$(".formularioVenta").on("change", "input#nuevoValorEfectivo", function(){
	...
	var nuevoSaldoEfectivo = $(this).parent().parent().parent().children('#capturarCambioEfectivo').children().children('#nuevoSaldoEfectivo');

	nuevoSaldoEfectivo.val(cambio);
	
	$('#nuevoSaldoEfectivo').number( true);
